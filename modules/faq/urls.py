...
urlpatterns = [
    ...
    path('delete-flutter/<int:faq_id>/', views.delete_faq_flutter, name='delete_faq_flutter'),
    path('update-flutter/<int:faq_id>/', views.update_faq_flutter, name='update_faq_flutter'),
]